        ...
        <Card className=' w-full h-full border-none shadow-none'>
            <CardHeader className=' flex flex-row items-center gap-x-4 p-7 space-y-0'>
                ...
                <CardTitle className=' text-xl font-bold'>
                    {initialValues.name} 
                    {' '}
                <i className='text-sm text-gold'>project Setting</i>
                </CardTitle>
            </CardHeader>
            <div className='px-7'>
                ...
                <Form {...form}>
                    <form onSubmit={form.handleSubmit(onSubmit)}>
                            ...
                            <div className='flex flex-col gap-y-2'>
                                    <div className=' flex items-center gap-x-5'>
                                        ...
                                        <div className='flex flex-col'>
                                            <p className='text-sm'>project Logo</p>
                        ...
                        <div className='flex items-center justify-between'>
                         <Button type="button" variant='secondary' size='lg' onClick={onCancel} disabled={isPending || isDeletingProject} className={cn( !onCancel && ' invisible')}>cancel</Button>
                         <Button type="submit" size='lg' disabled={isPending || isDeletingProject}>Save Changes</Button>
                        </div>
                    </form>
                </Form>
            </CardContent>
        ...
        <Card className='w-full h-full border-none shadow-none'>
            <CardContent className='p-7'>
                <div className='flex flex-col '>
                    ...
                    <Button className='mt-6 w-fit ml-auto' size='sm' variant='destructive' type='button' disabled={isPending || isDeletingProject} onClick={handleDelete}>Delete</Button>
                </div>
            </CardContent>
        </Card>
    </div>
