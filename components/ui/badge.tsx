  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        [TaskStatus.TODO]: 'border-transparent bg-gold text-primary hover:bg-gold/80',
        [TaskStatus.IN_PROGRESS]: 'border-transparent bg-purple-400 text-primary hover:bg-purple-400/80',
